...
var _iterator = _createForOfIteratorHelper(reversedArray),
  _step;
try {
...
var Brand = car.Brand,
  Model = car.Model,
  Year = car.Year;
console.log("Zna\u010Dka: ".concat(Brand, ", Model: ").concat(Model, ", Rok: ").concat(Year));
var randomNum = Math.floor(Math.random() * 556);
console.log("N\xE1hodn\xE9 \u010D\xEDslo je: ".concat(randomNum));
